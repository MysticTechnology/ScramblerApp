...
* Github repo: https://github.com/MysticTechnology/ScramblerApp
* PyPi: https://pypi.org/project/ScramblerApp/

![alt text](https://github.com/MysticTechnology/ScramblerApp/blob/main/doc/scrambler-preview.gif?raw=true)
...
```
git clone https://github.com/MysticTechnology/ScramblerApp.git
cd ScramblerApp
pip3 install -e .
```
...
![alt text](https://github.com/MysticTechnology/ScramblerApp/blob/main/doc/scrambler-mainmenu.png?raw=true)
